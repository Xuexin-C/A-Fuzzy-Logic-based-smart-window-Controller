...
indoorTemp_range = np.arange(-10, 46, 1, np.float32)
...
result3 = []
result4 = []
# Independent Variable: Outdoor Temperature
# for i in range(-10, 60):
#     a = i
#     x = [40, a, 30, 400]
#     sim.input['userInteraction_input'] = x[0]
#     sim.input['outdoorTemp_input'] = x[1]
#     sim.input['indoorTemp_input'] = x[2]
#     sim.input['Lux_input'] = x[3]
#     sim.compute()
#     output_Tv = sim.output['Tv_output']
#     result.append(output_Tv)
# print(result)
#
# for i in range(-10, 60):
#     a = i
...
#     sim.compute()
#     output_Tv = sim.output['Tv_output']
#     result3.append(output_Tv)
# print(result3)

# Independent Variable: Indoor Temperature
...
t = np.linspace(-10, 45, 55)
fig, (ax4) = plt.subplots()
ax4.plot(t, result, 'b', label='outdoorTemp=hot, Lux =too bright')
ax4.plot(t, result1, 'g', label='outdoorTemp=cold, Lux =too bright')
ax4.plot(t, result2, 'r', label='outdoorTemp=hot, Lux =dark')
ax4.plot(t, result3, 'm', label='outdoorTemp=cold, Lux =dark')
ax4.set_title('Tv vary with indoor temperature')
ax4.legend()
plt.show()